...
export const SubscriptionCheckout = () => {
  ...
  const handleSubmitStripeButtonClick = () => {
    ...
    if (isTrialEligible) {
      segmentEvent =
        "edx.bi.user.subscription.program.checkout.start-trial.click";
    }
    sendTrackEvent(segmentEvent, {
      type: "click",
      category: "checkout",
  ...
  return (
    <section
      aria-label={intl.formatMessage(
        messages["subscription.checkout.payment.label"]
      )}
    >
      {!loading ? (
